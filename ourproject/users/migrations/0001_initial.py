    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_staff",
                    models.BooleanField(default=False, verbose_name="is_user"),
                ),
                (
                    "is_admin",
                    models.BooleanField(default=False, verbose_name="is_user"),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="accepted_couriers",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    "destination_received_by",
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="destination_accepted_by",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="sent_courier_images",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="uploaded_courier_images",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
